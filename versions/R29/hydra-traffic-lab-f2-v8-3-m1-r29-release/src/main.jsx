...
const HYDRA_VERSION_LABEL = "F2-V8.3-M1-R29";
const HYDRA_VERSION_SLUG = "f2-v8-3-m1-r29-release";
...
function makeDefaultHydraUsers(projects = []) {
  const projectIds = projectIdsForDefaults(projects);
  return [
    { id: "user-superadmin", name: "Superadministrador Hydra", username: "superadmin", roleId: "superadmin", pin: "9999", projectIds: ["*"], active: true, projectPermissions: {} },
    { id: "user-admin-city", name: "Administrador ciudad", username: "admin", roleId: "admin", pin: "1234", projectIds, active: true, projectPermissions: {} },
    { id: "user-supervisor", name: "Supervisor turno", username: "supervisor", roleId: "supervisor", pin: "4444", projectIds, active: true, projectPermissions: {} },
    { id: "user-operador", name: "Operador sala", username: "operador", roleId: "operator", pin: "2222", projectIds, active: true, projectPermissions: {} },
    { id: "user-ingenieria", name: "Ingenieria trafico", username: "ingenieria", roleId: "engineering", pin: "5555", projectIds, active: true, projectPermissions: {} },
    { id: "user-mantenimiento", name: "Mantenimiento campo", username: "mantenimiento", roleId: "maintenance", pin: "3333", projectIds, active: true, projectPermissions: {} },
    { id: "user-consulta", name: "Consulta municipal", username: "consulta", roleId: "viewer", pin: "0000", projectIds, active: true, projectPermissions: {} },
    { id: "user-emergencia", name: "Emergencia local", username: "emergencia", roleId: "emergency", pin: "9110", projectIds, active: true, projectPermissions: {} },
  ];
}
...
function App() {
  ...
  function logout() {
    ...
    if (user && role) setAudit((old) => [makeAuditEntryFor(user, role, activeProject, "acceso", "cierre de sesion", user.username, "ok", "viewSystem"), ...old].slice(0, 400));
  }
