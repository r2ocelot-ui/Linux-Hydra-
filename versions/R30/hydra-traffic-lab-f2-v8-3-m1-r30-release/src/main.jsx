...
const HYDRA_VERSION_LABEL = "F2-V8.3-M1-R30";
const HYDRA_VERSION_SLUG = "f2-v8-3-m1-r30-release";
    ...
    if (activeSection === "Mapa del sistema") {
      return (
        <SectionPage title="Mapa del sistema" help={[
          ...
          "El conteo de cruces vive en el resumen del Centro de Control."
        ]}>
          {renderMapAndControl()}
          {renderCorridor()}
        </SectionPage>
    ...
    if (activeSection === "Cruces") {
      return (
        <SectionPage title="Cruces" help={[
          "Ficha completa del cruce seleccionado: control, geometria, demanda, hardware y camaras.",
          "Selecciona un marcador en el mapa o usa el panel Mapa del sistema para cambiar de cruce.",
          "Operacion del regulador, modos manual/local/averia y manual asistido necesitan permiso operateCrossings.",
    ...
    if (activeSection === "Eventos") {
      return (
        <SectionPage title="Eventos" help={[
          "Registro vivo: acciones manuales, bloqueos por permiso y comprobaciones del sistema.",
          "La auditoria estructurada se guarda en localStorage propio y se puede exportar a JSON.",
          "Los KPIs del resumen suman eventos, auditoria, errores, avisos y bloqueos."
        ]}>
