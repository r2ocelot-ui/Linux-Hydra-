...
const HYDRA_VERSION_LABEL = "F2-V8.3-M1-R40";
const HYDRA_VERSION_SLUG = "f2-v8-3-m1-r40-release";
    ...
    <div className="hardware-panel">
      <Panel>
        ...
        <div className="hw-actions-row">
          ...
          <PermissionButton role={activeRole} permission="maintainHardware" onDenied={onPermissionDenied} onClick={doAllOff} disabled={busy} action="apagar todos los relés" variant="danger">Apagar todo</PermissionButton>
