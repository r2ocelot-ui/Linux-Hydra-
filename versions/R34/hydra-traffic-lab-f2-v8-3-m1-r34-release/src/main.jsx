...
const HYDRA_VERSION_LABEL = "F2-V8.3-M1-R34";
const HYDRA_VERSION_SLUG = "f2-v8-3-m1-r34-release";
...
function LoginModalR26({ open, usernameInput, pin, error, onUsernameChange, onPinChange, onSubmit, onClose }) {
  if (!open) return null;
  return (
    <div className="access-modal-backdrop" role="presentation">
      <div className="access-modal" role="dialog" aria-modal="true" aria-label="Acceso Hydra">
