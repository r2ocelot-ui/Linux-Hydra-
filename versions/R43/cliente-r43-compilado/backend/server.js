  ...
  function startPolling() {
    ...
    pollingTimer = setInterval(async () => {
      ...
      try {
        ...
        // R42: limpiar lastError si el polling fue exitoso. Antes un error
        // transitorio (modbus timeout, etc.) se quedaba pegado en el panel
        // aunque ya hubiera vuelto la conexión. Si el state cambió, además
        // emitimos el broadcast con lastError:"" para refrescar el frontend.
        const hadError = !!lastError;
