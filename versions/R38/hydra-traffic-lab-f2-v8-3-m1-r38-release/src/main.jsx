...
const HYDRA_SECTIONS = ["Inicio", "Mapa del sistema", "Cruces", "Coordinación", "Escenarios", "Informes", "Eventos", "Dispositivos", "Cámaras", "Configuración", "Usuarios", "Sistema"];
const HYDRA_VERSION_LABEL = "F2-V8.3-M1-R38";
const HYDRA_VERSION_SLUG = "f2-v8-3-m1-r38-release";
...
function App() {
  ...
  }, [crossings, manualLinks, tick, selectedId, corridorIds, settings, log, audit, activeProjectId, activeProject?.name]);
