...
const HYDRA_VERSION_LABEL = "F2-V8.3-M1-R42";
const HYDRA_VERSION_SLUG = "f2-v8-3-m1-r42-release";
...
function getSignal(crossing, tick, settings) {
  ...
  normalizedGeometry.signalHeads.forEach((head) => {
    ...
    if (stage === "green") {
      // Caso 1: head con tipo doble ámbar pedido como "double_amber".
      // Alternamos amber_1 ↔ amber_2 según paridad del tick.
      ...
      // Caso 2: peatón con verde pedido durante el stage green.
      // Aplica sub-stage: solid → flashing (1Hz) → clearance (rojo).
      else if (head.groupType === "pedestrian" && (requestedState === "ped_green" || requestedState === "green") && head.optics.includes("ped_green")) {
      ...
      // Caso 3: cualquier otro head durante green → comportamiento normal.
      else {
        resolved = outputStateForHead(head, requestedState);
      }
    } else {
